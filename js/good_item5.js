...
function updateControlBarLeft() {
  ...
  if (currentLeft === 0) {
    newBarLeft = 0; // p1
  } else if (currentLeft === -26.5) {
    newBarLeft = 20; // p2
  } else if (currentLeft === -53) {
    newBarLeft = 40; // p3
  } else if (currentLeft === -79.5) {
    newBarLeft = 60; // p4
  } else if (currentLeft === -106) {
    newBarLeft = 80; // p5
  }
...
function updateSelectedPreview() {
  ...
  if (currentLeft === 0) {
    ...
    document.querySelector(".p5").classList.add("selected");
  }
}
